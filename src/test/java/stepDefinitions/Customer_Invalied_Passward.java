...
public class Customer_Invalied_Passward extends Base {
	...
	public void i_will_check(String string) {
		invalidpass.InValiedPasswordCheck();
		System.out.println("complete********** = " + invalidpass.InValiedPasswordCheck());
		assertEquals("Invalid username or password!", invalidpass.InValiedPasswordCheck());
